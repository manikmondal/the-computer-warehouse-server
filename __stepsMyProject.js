/**
 * **. Create a node server Computer Warehouse with 5 steps**
 * 1. create folder
 * 2. npm init
 * 3. npm i express cors mongodb
 * 4. script-dev: nodemon index.js
 * 5. create index.js
 * 6. full  steps setup to create a node server
 * 
 * 
 ...
 * ----------------------##########
 * 1. heroku account
 * 2.heroku login get start 
 * heroku project 
 * heroku dashboard my= project = settings= reveal config
 * copy past .env file
 * all ip address mongodb
 * connect server my client computer warehouse
 * 
*/